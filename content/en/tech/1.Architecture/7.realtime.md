...
### 3.2 Redis Stream Xread and Message Dispatching

The **DUCO Studio Server** connects to the **Redis (Stream)** service used by the **Distributor Server**.
...
- 3. Messages are picked by filedList and sent to the client
...
- **Xread Redis Stream**: `live-stream/ce_technology/vehicle_can`
...
- **XRead Redis Stream**: `live-stream/ce_technology/client_raw_data`
...
:iframe{allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allow-full-screen="true" frame-border="0" referrer-policy="strict-origin-when-cross-origin" src="/videos/liveData.mp4" style="aspect-ratio: 16/9; width: 100%;" title="Live Data Demo"}
...
RT -->|Stream XAdd parsed Real time Data| REDIS
...
```ts [POST /api/iothubs/ducohub/devices/${chassisId}/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods\\] {0} [POST /api/iothubs/ducohub/devices/$/methods]
{
...
- 2026-02-06: Updated the RealTime Data Control via Redis(Pub Sub) to Redis Stream(XAdd XRead)
